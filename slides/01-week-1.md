...
-   Gearbeiten wird auf einem Branch
...
6.  nach Reviewn in master mergen
...
6. Erstelle einen branch
7. Mache eine Änderung und comitte und pushe sie
8. Erstelle einen Merge request
9. Akzeptiere den Merge request
...
| `clean`   | entfernt den target ordne                                                |
...
1. Wenn die Anzahl über 30 liegt gebe den Wert “Zu viele Personen zurück”
2. Wenn die Anzahl unter 30 liegt gebe den Wert “Maximale Personenzahl
   nicht überschritten”

-   Überlege dir erst die Methoden Signatur
...
-   Schreibe jeweils einen Test **und dann** die Funktionalität
    ...
    -   **Bonus:** Checke ob kleine/große Buchstaben enthalten sind
